...
function zap_panel_contact_form_shortcode($atts) {
    ...
    if (isset($_POST['zap_panel_contact_submit']) && wp_verify_nonce($_POST['zap_contact_nonce'], 'zap_panel_contact')) {
    ...
    if ($form_submitted || $submission_error) {
        echo '<div class="zap-panel-contact-message ' . ($submission_error ? 'error' : 'success') . '">';
    ...
    if (!$form_submitted) {
        ?>
        <div class="zap-panel-contact-form-container">
            <?php if (!empty($panel_ref) || !empty($panel_id)) : ?>
                <div class="zap-panel-contact-header">
                    <h3>Demande de réservation de panneau</h3>
                    <div class="zap-panel-details">
            ...
            <form method="post" class="zap-panel-contact-form">
                <?php wp_nonce_field('zap_panel_contact', 'zap_contact_nonce'); ?>
                ...
                <div class="zap-form-section">
                    <h4>Vos coordonnées</h4>
                    
                    <div class="zap-form-row">
                        <div class="zap-form-col">
                ...
                <div class="zap-form-section">
                    ...
                    <div class="zap-form-row">
                        <div class="zap-form-col full-width">
                ...
                <div class="zap-form-submit">
                    ...
                    <button type="submit" name="zap_panel_contact_submit" class="zap-submit-button">Envoyer ma demande</button>
                </div>
            </form>
        </div>
        
        <style>
            .zap-panel-contact-form-container {
                max-width: 800px;
                margin: 0 auto;
                padding: 20px;
                background: #f9f9f9;
            ...
            .zap-panel-contact-header {
                margin-bottom: 25px;
                padding-bottom: 15px;
                border-bottom: 1px solid #e5e5e5;
            }
            
            .zap-panel-contact-header h3 {
                color: #70c141;
                margin-top: 0;
                margin-bottom: 15px;
            }
            ...
            .zap-form-col.full-width {
                flex-basis: 100%;
            }
            
            .zap-panel-contact-form label {
                display: block;
                margin-bottom: 5px;
                font-weight: bold;
            }
            
            .zap-panel-contact-form input[type="text"],
            .zap-panel-contact-form input[type="email"],
            .zap-panel-contact-form input[type="tel"],
            .zap-panel-contact-form select,
            .zap-panel-contact-form textarea {
                width: 100%;
                padding: 10px;
            ...
            .zap-panel-contact-message.success {
                background-color: #dff2bf;
                color: #4f8a10;
                border: 1px solid #4f8a10;
            }
            
            .zap-panel-contact-message.error {
...
add_shortcode('zonify_panel_contact_form', 'zap_panel_contact_form_shortcode');

// Créer le type de post personnalisé pour les demandes de réservation
function zap_register_panel_request_post_type() {
    $labels = array(
...
add_action('init', 'zap_register_panel_request_post_type');

// Ajouter les métaboxes pour les détails de la demande
function zap_add_panel_request_meta_boxes() {
    add_meta_box(
        'panel_request_details',
        'Détails de la demande',
        'zap_panel_request_details_callback',
        'panel_request',
        'normal',
        'high'
    );
    ...
    add_meta_box(
        ...
        'Informations du contact',
        'zap_panel_request_contact_callback',
        'panel_request',
        'normal',
        'high'
    );
}
add_action('add_meta_boxes', 'zap_add_panel_request_meta_boxes');

// Callback pour la métabox des détails du panneau
function zap_panel_request_details_callback($post) {
    ...
    echo '<div class="zap-meta-field-row">';
    echo '<div class="zap-meta-field">';
...
function zap_panel_request_contact_callback($post) {
...
function zap_panel_request_admin_styles() {
...
add_action('admin_head', 'zap_panel_request_admin_styles'); 