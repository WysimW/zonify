...
function zonify_settings_page()
{
    ...
    if (isset($_POST['zonify_settings_submit']) && check_admin_referer('zonify_settings_nonce')) {
        ...
        update_option('zonify_always_show_all_zones', isset($_POST['zonify_always_show_all_zones']) ? 0 : 0);
        ...
        update_option('zonify_geocoder_position_front', sanitize_text_field($_POST['zonify_geocoder_position_front']));
