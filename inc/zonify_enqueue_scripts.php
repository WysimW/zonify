...
function zonify_enqueue_scripts($hook) {
    $allowed_hooks = array(
        ...
        'zonify_page_zonify_settings'  // Page "Réglages"
    );
    ...
    // Votre script personnalisé pour la gestion de la carte en backoffice
    ...
    // Passage des options à notre script
